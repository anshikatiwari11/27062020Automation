...
public class SendQuote {
	...
	By usernameError = By.xpath("//span[text()='Must be between 4 and 32 characters long and start with a letter. You may use letters, numbers, underscores, and one dot']");
	By usernameClick = By.xpath("//input[@id='username']");
	By password=By.xpath("//label[text()='Password']");
	By passwordError = By.xpath("//span[text()='Must be at least 6 characters long, and contain at least one number, one uppercase and one lowercase letter']");
