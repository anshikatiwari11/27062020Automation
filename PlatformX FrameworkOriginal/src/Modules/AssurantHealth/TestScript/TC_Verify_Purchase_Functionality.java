...
import ConfigFiles.Configuration;
...
public class TC_Verify_Purchase_Functionality {
	...
	public void beforeTest(String Browser) throws Exception {
		...
		if (Browser.equalsIgnoreCase("Firefox")) {
			...
			//System.setProperty("webdriver.gecko.driver", Configuration.geckoDriverPath);
			System.setProperty("webdriver.gecko.driver", System.getProperty("user.dir") + "\\src\\Utils\\geckodriver.exe");
			...
			System.setProperty("webdriver.ie.driver", System.getProperty("user.dir") + "\\src\\Utils\\IEDriverServer.exe");
			/*
	...
	public void f() throws Exception {
		...
		if (driver.findElement(By.className("login")).isDisplayed()) {
			Tc01.details_append("To verify application launch", "User should able to launch application",
					"User is able to launch application", "Pass");
		} else {
			Tc01.details_append("To verify application launch", "User should able to launch application",
					"User is not able to launch application", "Fail");
		}
		driver.findElement(By.className("login")).click();
		Thread.sleep(2000);
		// -------- Application Login -------------
		driver.findElement(By.id("email")).sendKeys("amazonpractice1989@gmail.com");
		driver.findElement(By.id("passwd")).sendKeys("anshika");
